...
class neuralnet():
    ...
    def init_params(self):
        # input will be of size 784 x 1
        # h1
        self.w1 = np.random.randn(10, 784) # (out_size=10 x 784)(784 x 1) + (out_size x 1) = (10, 1)
        self.b1 = np.random.randn(10, 1)
        # h2
        self.w2 = np.random.randn(10, 10) # (10, 10)(10 ,1) + (10,1)
        self.b2 = np.random.randn(10, 1)
        # h3
        self.w3 = np.random.randn(10, 10) # (10, 10)(10 ,1) + (10,1)
        self.b3 = np.random.randn(10, 1)
        # output
        self.w4 = np.random.randn(10, 10) # (10, 10)(10 ,1) + (10,1)
    ...
    def backward(self, x, y, lr):
        ...
        dz3 = np.dot(self.w4.T, dz4) * self.relu_derivative(fc['z3'])
        dw3 = np.dot(dz3, fc['a2'].T)
        db3 = np.sum(dz3)

        dz2 = np.dot(self.w3.T, dz3) *  self.relu_derivative(fc['z2'])
        dw2 = np.dot(dz2, fc['a1'].T)
        db2 = np.sum(dz2)

        dz1 = np.dot(self.w2.T, dz2) * self.relu_derivative(fc['z1'])
